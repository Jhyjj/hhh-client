    ...
    return (
        <div id="Search">
            <form onSubmit={onSubmit}>
                <input placeholder='당신이 머물고싶은 곳은 어떤 곳인가요?' className='searchinput' onChange={onChange} autoComplete="off"/>
                ...
                <Link to ='/searchResultk/바다'><input type="button" className='likebtn' onClick={onClick} value="바다"/></Link>
                    ...
                    <Link to ='/searchResultk/휴양지'><input type="button" className='likebtn' onClick={onClick} value="휴양지"/></Link>
